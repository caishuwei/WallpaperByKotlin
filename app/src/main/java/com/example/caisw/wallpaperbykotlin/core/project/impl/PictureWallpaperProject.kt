...
import com.example.caisw.wallpaperbykotlin.core.spirit.wallpaper.PictureWallpaper
import com.example.caisw.wallpaperbykotlin.core.surface.SurfaceHolderProvider

class PictureWallpaperProject(surfaceHolderProvider: SurfaceHolderProvider) : BaseProject(surfaceHolderProvider) {
    private var touchLine = TouchLine()
    private var wallpaper = PictureWallpaper()
